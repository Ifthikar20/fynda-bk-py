...
Industry-standard UUID-based user model with email authentication.
"""
...
class SearchHistory(models.Model):
    ...
    parsed_product = models.CharField(max_length=255, blank=True)
    parsed_budget = models.DecimalField(max_digits=10, decimal_places=2, null=True)
